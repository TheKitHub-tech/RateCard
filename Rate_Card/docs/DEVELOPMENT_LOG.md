...
- Reworked Equipment and Rooms & Spaces search/date layouts.
- Consolidated the request and VAT warning into one red bar.
- Moved weekend guidance into a triggered in-page pop-up.
- Added Excel full-rate-card and selected-basket exports.
- Added a mobile portrait usability pass.
- Added shared booking dates and times across tabs.
- Added the five equipment package presets.
- Added clear collapsible categories.
- Added PDF full-rate-card and selected-basket exports.
- Added Production/client name to exports and filenames.
- Corrected room display names and equipment brand metadata.
- Updated internal Quote Builder compatibility through V3.2.

## 7 August 2026: V4.3 baseline

- Published the combined Equipment, Rooms & Spaces and Basket workflow.
- Added the room catalogue, room pricing, technical support and campus-closure logic.
- Added the combined Excel Booking Request and email preparation workflow.
